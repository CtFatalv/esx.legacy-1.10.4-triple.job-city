...
return {
	...
	Ammunation = {
		...
		blip = {
			...
			{ name = 'pokemon_card', price = 300, metadata = { label = 'Charizard', description = 'It is said that Charizard’s fire burns hotter if it has experienced harsh battles.', image = 'water', type = 'Fire', hp = 78, attack = 84, defense = 78}}
		}, locations = {
